...
# applying custom response and not just return a default JSON format 
...
def get_product(id: int,  test_cookie: Optional[str] = Cookie(None)):
    if id > len(products):
        ...
        """
        return {
            HTMLResponse(content=out, media_type="text/html"),
